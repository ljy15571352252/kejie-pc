    ...
    <div class="container">
      <div>
        <div class="search-board">
          <el-input placeholder="请输入活动" size="mini" style="width: 200px" v-model="searchVal">
      ...
      <el-container>
        <el-main>
          <div v-if="pageTemplate.leftActivity">
        ...
        <el-aside width="250px" class="tr">
          <el-row>
            <el-col class="ternant-banner" v-for="(i,index) in pageTemplate.rightBanners" :key="index">
              <nuxt-link :to="i.url">
                <el-image :src="i.src" :alt="i.alt" fit="fill" style="width: 250px;height: 318px"></el-image>
              </nuxt-link>
            </el-col>
          </el-row>
        </el-aside>
